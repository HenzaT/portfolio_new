export const projectsData = [
  // Therapy Site
  {
    ...
    'description':
      `I worked collaboratively with a client to build this professional website.
  ...
  // Gimme a Song
  {
    ...
    'description':
      `A self-directed project built to help musicians overcome writer's block by generating random song elements.
  ...
  // React Weather
  {
    ...
    'description':
      `This <span class="highlight">React</span> app integrates a <span class="highlight">Flask</span> backend
  ...
  // aptist
  {
    ...
    'description':
      `This is a site to showcase my music. I used <span class="highlight">react router</span> for multiple pages,
